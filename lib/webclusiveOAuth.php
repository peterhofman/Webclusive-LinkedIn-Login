...
include_once('webclusiveOauthClass.php');
...
class webclusiveOAuth{
    ...
    public function getConsumer($consumerKey = null, $consumerSecret = null, $callbackUrl = null){          
      ...
      $consumer = new webclusiveOAuthConsumer($consumerKey,$consumerSecret,$callbackUrl);
      return $consumer;
    }
    ...
    public function requestToken(){
        ...
        if($this->getParameters()){
         ...
         $req = webclusiveOAuthRequest::from_consumer_and_token($consumer, NULL, "GET", $this->getRequestTokenUrl(), $parameters);
         $req->sign_request(new webclusiveOAuthSignatureMethod_HMAC_SHA1(), $consumer, NULL);
         $req_url = $req->to_url();
    ...
    public function accessToken(){
        ...
        if($this->getParameters()){
         ...
         $req = webclusiveOAuthRequest::from_consumer_and_token($consumer, $token, "GET", $this->getAccessTokenUrl(), $parameters);
         $req->sign_request(new webclusiveOAuthSignatureMethod_HMAC_SHA1(), $consumer, $token);
         $req_url = $req->to_url();
   ...
   function oAuthRequest($url) {
        ...
        if($this->getParameters()){
         ...
         $req = webclusiveOAuthRequest::from_consumer_and_token($consumer, $accessToken, $this->getRequestType(), $url, $parameters);
         $req->sign_request(new webclusiveOAuthSignatureMethod_HMAC_SHA1(), $consumer, $accessToken);
...
public function oAuthRequestPostXml($url){
    ...
    if($this->getParameters()){
     ...
     $req = webclusiveOAuthRequest::from_consumer_and_token($consumer, $accessToken, 'POST', $url, $this->getParameters());
     $req->sign_request(new webclusiveOAuthSignatureMethod_HMAC_SHA1(), $consumer, $accessToken);
